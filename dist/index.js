...
/***/ function(module, exports, __webpack_require__) {
	...
	React.render(React.createElement(MainApp, null), document.getElementById('main'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var undore = __webpack_require__(3);
	var PureRenderMixin = __webpack_require__(4).addons.PureRenderMixin;
	...
	var MainApp = React.createClass({displayName: "MainApp",
	  ...
	  undo: function() {
	    this.setState({
	      data: undore.undo(this.state.data)
	    })
	  },

	  redo: function() {
	    this.setState({
	      data: undore.redo(this.state.data)
	    })
	  },
	  ...
	  handleOnChange: function(i, e) {
	    ...
	    this.setState({ 
	      data: undore.set(this.state.data, 'todos', todos.setIn([i, 'checked'], e.target.checked)) 
	    });
	  },
	      ...
	      return (
	        React.createElement("li", {key: i}, 
	          React.createElement("label", null, 
	            React.createElement("input", {className: "check", type: "checkbox", checked: todo.get('checked'), onChange: this.handleOnChange.bind(this, i)}), 
	            todo.get('text')
	          )
	        )
	      );
	    ...
	    return (
	      React.createElement("div", null, 
	        React.createElement("p", null, 
	          React.createElement("input", {className: "btn undo", type: "button", value: "Undo", onClick: this.undo, 
	            disabled: this.state.data.get('history').isEmpty()}), 

	          React.createElement("input", {className: "btn redo", type: "button", value: "Redo", onClick: this.redo, 
	            disabled: this.state.data.get('redos').isEmpty()})
	        ), 
	        React.createElement("p", null, 
	          React.createElement("input", {className: "text", type: "text", placeholder: "Do something", value: this.state.text, onChange: this.handleTextChange}), 
	          React.createElement("input", {className: "btn add", type: "button", value: "Add", onClick: this.handleAddClick, disabled: this.state.text == ''})
	        ), 
